...
import 'package:rabbitchain_wallet/presentation/pages/create_wallet_page.dart';
...
void main() {
  ...
  group('CreateWalletPage', () {
    ...
    testWidgets(
      'submits successfully, shows backup dialog and enters dashboard',
      (WidgetTester tester) async {
        ...
        expect(find.text('请备份助记词'), findsOneWidget);
